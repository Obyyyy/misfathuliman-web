<x-layout>
    <main>
        ...
        ['nama' => 'Nama Guru 10', 'jabatan' => 'Guru B. Inggris', 'nip' => '197XXXXXXXXX', 'foto' => 'guru-10.jpg'],
                            ...
                            <div
                                class="group flex items-center space-x-4 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 p-3">
                                <!-- Foto kiri -->
                                <div
                                    class="relative flex-shrink-0 w-16 h-16 sm:w-20 sm:h-20 rounded-xl overflow-hidden bg-gradient-to-br from-primary/10 to-primary-dark/20 dark:from-gray-700 dark:to-gray-600">
                                    <img src="{{ asset('images/' . $guru['foto']) }}" alt="Foto {{ $guru['nama'] }}"
                                ...
                                <div class="flex-1 min-w-0">
                                    <p
                                        class="font-semibold text-sm text-gray-900 dark:text-white leading-tight truncate">
                                        {{ $guru['nama'] }}
                                    </p>
                                    <span
                                        class="inline-block mt-1 px-2 py-0.5 rounded-full text-xs bg-green-100 dark:bg-green-900/50 text-primary-dark dark:text-green-400 font-medium">
                                        {{ $guru['jabatan'] }}
                                    </span>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-5">
                        @foreach ([['nama' => 'Nama Staf 1', 'jabatan' => 'Kepala TU', 'foto' => 'kepmad.png'], ['nama' => 'Nama Staf 2', 'jabatan' => 'Staf TU', 'foto' => 'staf-2.jpg'], ['nama' => 'Nama Staf 3', 'jabatan' => 'Pustakawan', 'foto' => 'staf-3.jpg'], ['nama' => 'Nama Staf 4', 'jabatan' => 'Penjaga Sekolah', 'foto' => 'staf-4.jpg']] as $staf)
                            <div
